        ...
        return (
          ...
          >
            <button
              ...
              className="w-full px-4 py-4 text-left transition hover:bg-slate-800/45"
            >
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <div className="mb-1 flex flex-wrap items-center gap-2">
                    <h3 className="truncate text-sm font-semibold text-slate-100 md:text-base">{item.name}</h3>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-xs md:text-sm">
                    ...
                    <span className="text-slate-400">최근 1개월 실제 수익률</span>
                    <ReturnBadge value={item.return1M} />
                  </div>
                </div>
                <span className="rounded-xl border border-slate-700/80 p-2 text-slate-300">
            ...
            {expanded && (
              <div className="grid grid-cols-2 gap-2 border-t border-slate-700/70 bg-slate-900/70 px-4 py-4 sm:grid-cols-4">
